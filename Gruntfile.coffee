module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    files:
      ...
      js:
        vendor: [
          ...
          "bower_modules/base64/base64.js"
        ]
    ...
    server:
      base: "#{process.env.SERVER_BASE || 'generated'}" #Run this code from command line to simulate production from "dist" directory: SERVER_BASE=dist grunt prodsim
      web:
        port: 8000
